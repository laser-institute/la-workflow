...
```{python}
#select the variables and create a new dataFrame called data_cleaned
...
# Step 2: Verify that there are no missing values in data_cleaned
print(data_cleaned.isna().sum())
...
Quarto "data product" designed to illustrate key findings. Feel free
