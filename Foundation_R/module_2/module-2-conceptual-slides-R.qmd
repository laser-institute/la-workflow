...
subtitle: "LAW Module 2: Conceptual Overview"
format: 
  revealjs:
...
-   Complete the *Explore* section of the [case study](https://posit.cloud/spaces/493094/join?access_code=qjsumVzA0HZYgrxOSizVbVPmDs7iHYS32yUQaqDe)
-   Complete the [Data Visualizations Basics](https://laser-institute.github.io/la-workflow/Foundation_R/module_2/Module2-badge-R-KEY.html) badge
-   Do [essential readings for the next module](https://laser-institute.github.io/la-workflow/Foundation_R/module_3/module-3-conceptual-slides-R.html#/module-3-objectives)
:::
