...
+--------------------+-------------------------------------------------+
| `e                 | reason student decided to take the course       |
| nrol lment_reason` |                                                 |
+--------------------+-------------------------------------------------+
| `e                 | ap pr ove/enrolled, dropped, withdrawn          |
| nrol lment_status` |                                                 |
+--------------------+-------------------------------------------------+
...
If you want ot look for NA's in all your columns you can use dplyr along with the is.na() function to check for NA's in your columns
```{r}
data_to_explore %>%
...
Create a Data Story with our current data set, or your own. Make sure to use the LA
workflow as your guide to include
