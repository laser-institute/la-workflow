...
subtitle: "LAW Module 1: Conceptual Overview"
format: 
  revealjs:
...
-   Optional Readings on Stakeholders in folder By Gašević et al., 2022
    and Sun et al., 2019
:::
::::
...
:::: {.column width="60%"}
::: fragment
![](img/granularity.png){.absolute top="150" left="850" width="1000"}
:::
::::
:::::::
...
According to Krumm et al., Digital Learning Environments have fueled
data intensive research in education more than any other data.
...
-   Choose one category (Interaction, Administrative, Demographic, or
    Student Affectivity).
...
-   What challenges arise from the different needs and priorities of
    these stakeholder groups when it comes to data use and management?
