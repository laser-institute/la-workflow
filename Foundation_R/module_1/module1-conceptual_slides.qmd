...
2. [Learning Analytics Goes to School, (Wrangle Ch. 3, pp. 39 - 43) By Andrew Krumm, Barbara Means, Marie Bienkowski](https://laser-institute.github.io/LASER_Foundations_2023//lab2/Readings/Learning%20Analytics%20Goes%20to%20School.pdf)
3. [Educational data mining and learning analytics: An updated survey, By Romero & Ventura](https://laser-institute.github.io/LASER_Foundations_2023/lab1/Readings/Educational_data_mining_and_learning_analytics.pdf)
:::
:::
...
:::{.column width="60%"}
![](img/la_ed_environments.png){.absolute .fragment top="150" right="50" width="1000"}
:::
:::
...
:::{.notes}
Direct Beneficiaries
Students: Primary beneficiaries whose performance and engagement are directly impacted by data.
Parents and Guardians: Receive data about their child's progress and use it to support their learning.

Educational Practitioners
Teachers: Use data to inform instruction and personalize learning, and contribute data through assessments.
School Administrators: Oversee data collection and analysis, and use data to make strategic decisions.

Policy and Decision Makers
District and State Education Officials: Develop and evaluate policies using aggregated data.
Policy Makers and Government Agencies: Develop regulations and allocate funding based on data.

Data and Technology Providers
Educational Technology Providers: Offer tools and platforms for data management and analysis.
Educational Researchers: Use data for research to improve educational practices.

Community and Support Organizations
Community Members and Organizations: Advocate for educational improvements using data insights.
Non-Profit Organizations: Use data to advocate for reforms and support specific populations.

Economic Stakeholders
Employers and Industry Representatives: Interested in data related to skills and workforce readiness.
Funding Agencies and Foundations: Evaluate the impact of programs and provide funding based on data.
