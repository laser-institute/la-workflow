...
5.  In code chunk named `select-2` *select* all columns except `subject` and `section`. *Assign* to a new object with a different name. *Inspect* your data frame with a different `function`.
