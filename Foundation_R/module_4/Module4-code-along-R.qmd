...
## Welcome to LAW code-a-long for Module 4

-   In the communicate section of the Learning Analytics workflow, the
...
-   The goal is to ensure that the findings are easily understood and
    can inform decision-making processes, ultimately leading to improved
...
-   Process can be automated using R and R Markdown, and knitted using
    Quarto

-   Dashboards are valuable because they can include interactive
    elements
...
-   To do this with Quarto Dashboards, add interactive
...
[Quarto Dashboard Gallery
layouts](https://quarto.org/docs/gallery/#dashboards)

[Quarto dashboard: Easy interactive dashboards for
...
-   Complete the `Dashboard for the Stakeholder` parts of the case
    study.
-   Complete the Badge requirement document [Foundations badge - Data
    Sources](https://laser-institute.github.io/la-workflow/Foundation_R/module_4/Module4-badge-R-KEY.html)
:::
