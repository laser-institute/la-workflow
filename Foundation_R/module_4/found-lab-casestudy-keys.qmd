...
+-----------------------------------+
| **Introduction to the             |
| [Stakeholder]{.underline}**       |
+===================================+
| **Name:** Alex Johnson            |
|                                   |
| **Role:** University Science      |
| Professor                         |
|                                   |
...
|                                   |
| **Goal:** Alex aims to improve    |
| student engagement and            |
| performance in her online science |
| classes.                          |
+-----------------------------------+
...
+---------------+-----------------+
| `enrol        | reason student  |
| lment_reason` | decided to take |
|               | the course      |
+---------------+-----------------+
| `enrol        | ap              |
| lment_status` | prove/enrolled, |
|               | dropped,        |
|               | withdrawn       |
+---------------+-----------------+
| `time_spent`  | Time spent in   |
|               | hours for       |
|               | entire course   |
+---------------+-----------------+
...
| Variable        | Description                       |
+=================+===================================+
| `total_p        | available points for the course   |
| oints_possible` |                                   |
+-----------------+-----------------------------------+
| `total          | stud \| ent earned for the entire |
| _points_earned` | course \|                         |
+-----------------+-----------------------------------+
...
The `c()` function from the {baser} package in R is used used to combine
or concatenate its argument. You can use it to get the output by giving
...
Now you can assign labels to students at by assigning **pass** if
`proportion_earned` is greater or equal than 50 or **fail** if it is
lower.
